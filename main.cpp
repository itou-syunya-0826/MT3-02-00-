...
int WINAPI WinMain(HINSTANCE, HINSTANCE, LPSTR, int) {
	...
	//点の描画
	Matrix::Sphere pointSphere{ point, 0.01f };
	Matrix::Sphere closestPointSphere{ ClosestPoint,0.01f };
	...
	while (Novice::ProcessMessage() == 0) {
		...
		matrix.DrawSphere(pointSphere, viewProjectionMatrix, viewportMatrix, RED);
		matrix.DrawSphere(closestPointSphere, viewProjectionMatrix, viewportMatrix, BLACK);;
